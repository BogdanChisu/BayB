...
class Product(models.Model):
    ...
    image_1 = models.ImageField(upload_to='product_pics', null=True)
    image_2 = models.ImageField(upload_to='product_pics', null=True)
    image_3 = models.ImageField(upload_to='product_pics', null=True)
